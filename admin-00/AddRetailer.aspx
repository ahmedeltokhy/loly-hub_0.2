<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddRetailer.aspx.cs" Inherits="loly_hub_0._2.admin.AddRetailer" %>
                            ...
                            <div class="col-lg-8">
                                <form enctype="multipart/form-data" id="userForm" runat="server" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-row">
                                                <input type="text" class="form-control" id="Nametxt" runat="server" placeholder="Retailer's Name">
                                            </div>
                                            <!-- End .input-row -->
                                        </div>
                                        <!-- End .col-md-6 -->
        ...
        window.onload = function () {
            $("#Submit1").click(function () {
                ...
                function addProgram() {
                    $.ajax({
                        type: "POST",
                        url: "AddRetailer.aspx/saveProgram",
                        data: '{name: "' + RetailerName + '",image:"' + imageSRC + '" }',
                ...
                function OnSuccess(response) {
                    alert(response.d);
                    window.location.replace("retailer.aspx");
                }
                return false;
            });
        };
