            ...
            $("#Submit1").click(function () {
                ...
                function addProduct() {
                    $.ajax({
                        ...
                        data: "{'images':'" + JSON.stringify(imgArray) + "','title':'" + title + "','price':'" + price + "','category':'" + category + "','retailer':'" + retailer + "','description':'" + description + "','id':'" + id + "','featured':'" + featured + "','earnedLP':'" + earnedLP + "'}",
