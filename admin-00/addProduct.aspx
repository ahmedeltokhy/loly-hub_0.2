            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    <div class="section title">
                        <div class="icon">
                            <img src="/admin/images/icons/users.png" alt="">
                        </div>
                        <!-- End .icon -->
                        <h3>Users </h3>
                    </div>
            ...
            $("#Submit1").click(function () {
                ...
                function addProduct() {
                    $.ajax({
                        ...
                        data: "{'images':'" + JSON.stringify(imgArray) + "','title':'" + title + "','price':'" + price + "','category':'" + category + "','description':'" + description + "','featured':'" + featured + "','earnedLP':'" + earnedLP + "','retailer':'" + retailer + "'}",
