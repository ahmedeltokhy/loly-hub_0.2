<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retailer.aspx.cs" Inherits="loly_hub_0._2.admin.retailer" %>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    <div class="section title">
                        <div class="icon">
                            <img src="images/icons/programs.png" alt=""></div>
                        <!-- End .icon -->
                        <h3>Retailers</h3>
                        <a class="btn btn-success" href="AddRetailer.aspx">ADD NEW</a>
                    </div>
                    <!-- End .section title -->
                    <div class="table-page">
                        <div runat="server" id="tableContainerRetailer" class="table-responsive">
                        </div>
