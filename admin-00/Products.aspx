<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="loly_hub_0._2.admin.Products" %>
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-2">
            <div class="section title">
              <div class="icon"><img src="images/icons/products.png" alt=""></div><!-- End .icon -->
              <h3>Products</h3>
              <a class="btn btn-success" href="/admin/addProduct.aspx">ADD NEW</a>
