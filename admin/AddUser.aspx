<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="loly_hub_0._2.admin.AddUser" %>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    ...
                    <div class="users-page">
                        <div class="row">
                            <div class="col-lg-8">
                                <form action="/admin/AddUser.aspx/saveUser" id="userForm" runat="server" method="post">
                                    <div class="input-row ">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- End .col-md-6 -->
                                          ...
                                          <div class="col-md-6">
                                            <div class="input-row">
                                                <select runat="server" id="retialerSelect" class="form-control" placeholder="retialer">
                                    ...
                                    <div class="input-row">
                                        <asp:Button class="btn btn-danger" OnClick="saveUser" runat="server" Text="SUBMIT" />
                                    </div>
                                    <!-- End .input-row -->
                                </form>
