<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addBranch.aspx.cs" Inherits="loly_hub_0._2.admin.addBranch" %>
    ...
    <script>
        window.onload = function () {
            $("#Submit1").click(function () {
                ...
                var dataArray = new Array(branchID,branchAddress,branchPhone,retailer);
                
                addProduct();
                function addProduct() {
                    $.ajax({
                        type: "POST",
                        url: "addBranch.aspx/saveBranch",
                ...
                function OnSuccess(response) {
                    alert(response.d);
                    window.location.replace("Branches.aspx");
                }
                return false;
            });
        };
