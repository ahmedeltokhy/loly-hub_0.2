<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="loly_hub_0._2.admin.users" %>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    <div class="section title">
                        ...
                        <!-- End .icon -->
                        <h3>Users </h3>
                        <a class="btn btn-success" href="/admin/AddUser.aspx">ADD NEW</a>
                    </div>
                    <!-- End .section title -->
