<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProgramCategories.aspx.cs" Inherits="loly_hub_0._2.admin.ProgramCategories" %>
...
<head>
    ...
    <title>CMS-Programs Categries Page</title>
...
<body>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    <div class="section title">
                        ...
                        <!-- End .icon -->
                        <h3>Categories</h3>
                        <a class="btn btn-success" href="/admin/AddProgramCategory.aspx">ADD NEW</a>
                    </div>
                    <!-- End .section title -->
    ...
    <script>
        function deleteUser(id, row) {
            $.ajax({
                type: "POST",
                url: "ProgramCategories.aspx/delete",
                data: '{id: ' + id + '}',
