...
<html>
  ...
  <body>
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-2">
            <div class="section title">
              <div class="icon"><img src="/admin/images/icons/users.png" alt=""></div><!-- End .icon -->
              <h3>Users </h3>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="input-row">
                          ...
                          <input class="form-control" id="featured" type="checkbox" runat="server" />
                        </div><!-- End .input-row -->
                      </div><!-- End .col-md-6 -->
                    </div><!-- End .row -->
    ...
    <footer>
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="visa"><img src="/admin/images/visa.png" alt=""></div><!-- End .visa -->
          </div><!-- End .col-sm-6 -->
        </div><!-- End .row -->
      </div><!-- End .container -->
    </footer>
      ...
      <script>
          window.onload = function () {
              ...
              $("#Submit1").click(function () {
                  ...
                  if (imageSRC.length == 0 && $("#container_temp .jFiler-item .jFiler-item-container .jFiler-item-thumb img").length == 0) {
    ...
    $.ajax({
        ...
        data: "{'images':'" + JSON.stringify(imgArray) + "','title':'"+title+"','price':'"+price+"','category':'"+category+"','description':'"+description+"','id':'"+id+"'}",
