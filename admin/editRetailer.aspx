<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editRetailer.aspx.cs" Inherits="loly_hub_0._2.admin.editRetailer" %>
        ...
        window.onload = function () {
            $("#Submit1").click(function () {
                ...
                function addProgram() {
                    $.ajax({
                        type: "POST",
                        url: "editRetailer.aspx/saveProgram",
                        data: '{name: "' + programName + '",image:"' + imageSRC + '",id:' + parseInt(id) + ' }',
