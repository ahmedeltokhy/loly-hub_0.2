<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editProgram.aspx.cs" Inherits="loly_hub_0._2.admin.editProgram" %>
    ...
    <script>
        window.onload = function () {
            $("#Submit1").click(function () {
                var imageSRC;
                if ($(".jFiler-item-thumb-image img").length) {
                    imageSRC = $(".jFiler-item-thumb-image img")[0].src;
                }
                else {
                    imageSRC = null;
                }
                ...
                function addProgram() {
                    $.ajax({
                        type: "POST",
                        url: "editProgram.aspx/saveProgram",
                        data: '{name: "' + programName + '",image:"' + imageSRC + '",id:' + parseInt(id) + ',rate:' + rate + ',revenue:' + revenu + ' }',
                ...
                function OnSuccess(response) {
                    alert(response.d);
                    window.location.replace("Programs.aspx");
                }
                return false;
            });
        };
