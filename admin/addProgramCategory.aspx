<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="addProgramCategory.aspx.cs" Inherits="loly_hub_0._2.admin.addProgramCategory" %>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    ...
                    <div class="users-page">
                        <div class="row">
                            <div class="col-lg-8">
                                <form action="addProgramCategory.aspx/saveCategory" id="userForm" runat="server" method="post">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-row">
                                            <asp:Button class="btn btn-danger" runat="server" Text="SUBMIT" OnClick="Unnamed1_Click" />
                                        </div>
                                        <!-- End .input-row -->
                                    </div>
                                </form>
