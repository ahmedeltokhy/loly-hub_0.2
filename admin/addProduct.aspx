<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addProduct.aspx.cs" Inherits="loly_hub_0._2.admin.addProduct" %>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    <div class="section title">
                        <div class="icon">
                            <img src="/admin/images/icons/products.png" alt="">
                        </div>
                        <!-- End .icon -->
                        <h3>Products </h3>
                    </div>
    ...
    <script>
        window.onload = function () {
            $("#Submit1").click(function () {
                ...
                var imageSRC = $(".jFiler-item-thumb-image img");
                ...
                function addProduct() {
                    $.ajax({
                        type: "POST",
                        url: "addProduct.aspx/saveProduct",
                        // data: '{name: "' + programName + '",image:"' + imageSRC + '" }',
                        data: "{'images':'" + JSON.stringify(imgArray) + "','title':'" + title + "','price':'" + price + "','category':'" + category + "','description':'" + description + "','featured':'" + featured + "','earnedLP':'" + earnedLP + "','retailer':'" + retailer + "','earnedExpiry':'"+earnedExpiry+"','productExpiry':'"+productExpiry+"'}",
