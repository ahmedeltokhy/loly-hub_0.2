<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Branches.aspx.cs" Inherits="loly_hub_0._2.admin.Branches" %>
...
<body>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    <div class="section title">
                        ...
                        <!-- End .icon -->
                        <h3>Programs</h3>
                        <a class="btn btn-success" href="addBranch.aspx">ADD NEW</a>
                    </div>
                    <!-- End .section title -->
    ...
    <script>
        function deleteBranch(id, row) {
            $.ajax({
                type: "POST",
                url: "Branches.aspx/delete",
                data: '{id: ' + id + '}',
