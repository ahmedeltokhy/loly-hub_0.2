<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Programs.aspx.cs" Inherits="loly_hub_0._2.admin.Programs" %>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    <div class="section title">
                        ...
                        <!-- End .icon -->
                        <h3>Programs</h3>
                        <a class="btn btn-success" href="/admin/AddProgram.aspx">ADD NEW</a>
                    </div>
                    <!-- End .section title -->
